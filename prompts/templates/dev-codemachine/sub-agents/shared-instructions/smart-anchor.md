...
Your primary formatting task is to make the architectural blueprint "addressable" by strategically placing feature anchors onto the relevant sections of the text. Your goal is to create a rich context map that links every architectural decision to the features it impacts.
