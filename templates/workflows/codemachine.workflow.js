export default {
  ...
  steps: [
    resolveStep('git-commit', { executeOnce: true, engine: 'codex' }), // Commit the initial project specification to git
    ...
    resolveStep('git-commit', { executeOnce: true, engine: 'codex' }), // Commit the task breakdown to git
