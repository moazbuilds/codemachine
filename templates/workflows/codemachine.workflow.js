export default {
  ...
  steps: [
    ...
    resolveStep('task-breakdown', { executeOnce: true, engine: 'codex', notCompletedFallback: 'task-fallback' }), // Extract and structure tasks from project plan into JSON format
